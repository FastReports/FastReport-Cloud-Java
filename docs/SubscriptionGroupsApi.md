...
| [**subscriptionGroupsCountGroupsAsyncWithHttpInfo**](SubscriptionGroupsApi.md#subscriptionGroupsCountGroupsAsyncWithHttpInfo) | **GET** /api/manage/v1/Subscriptions/{subscriptionId}/count | Returns a number of groups in subscription |
...
| [**subscriptionGroupsGetGroupsListWithHttpInfo**](SubscriptionGroupsApi.md#subscriptionGroupsGetGroupsListWithHttpInfo) | **GET** /api/manage/v1/Subscriptions/{subscriptionId}/groups | returns groups of the subscription or subscription user |
...
## subscriptionGroupsCountGroupsAsyncWithHttpInfo

> ApiResponse<Long> subscriptionGroupsCountGroupsAsync subscriptionGroupsCountGroupsAsyncWithHttpInfo(subscriptionId)
...
public class Example {
    public static void main(String[] args) {
        ...
        String subscriptionId = "subscriptionId_example"; // String | subscripiton id
        try {
            ApiResponse<Long> response = apiInstance.subscriptionGroupsCountGroupsAsyncWithHttpInfo(subscriptionId);
...
## subscriptionGroupsGetGroupsListWithHttpInfo

> ApiResponse<GroupsVM> subscriptionGroupsGetGroupsList subscriptionGroupsGetGroupsListWithHttpInfo(subscriptionId, userId)
...
public class Example {
    public static void main(String[] args) {
        ...
        String userId = "userId_example"; // String | user Id (optional)
        try {
            ApiResponse<GroupsVM> response = apiInstance.subscriptionGroupsGetGroupsListWithHttpInfo(subscriptionId, userId);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
            System.out.println("Response body: " + response.getData());
        } catch (ApiException e) {
