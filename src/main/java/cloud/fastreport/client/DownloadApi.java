  ...
  /**
    ...
    **/
    ...
    public HttpResponse downloadGetLastSVGExportForHttpResponse(String reportId) throws IOException {
        ...
        if (reportId == null) {
            throw new IllegalArgumentException("Missing the required parameter 'reportId' when calling downloadGetLastSVGExport");
        }
        // create a map of path variables
        final Map<String, Object> uriVariables = new HashMap<String, Object>();
        uriVariables.put("reportId", reportId);
        UriBuilder uriBuilder = UriBuilder.fromUri(apiClient.getBasePath() + "/download/lastPreview/{reportId}");
