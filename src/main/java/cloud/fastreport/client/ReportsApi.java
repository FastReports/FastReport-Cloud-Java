...
public class ReportsApi {
    ...
    /**
     * Build call for reportFolderAndFileCountRecycleBinFoldersAndFiles
     * @param subscriptionId subscription id (required)
     ...
     */
    public okhttp3.Call reportFolderAndFileCountRecycleBinFoldersAndFilesCall(String subscriptionId, String searchPattern, Boolean useRegex, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/rp/v1/Reports/{subscriptionId}/CountRecycleBinFolderAndFiles"
            .replace("{" + "subscriptionId" + "}", localVarApiClient.escapeString(subscriptionId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call reportFolderAndFileCountRecycleBinFoldersAndFilesValidateBeforeCall(String subscriptionId, String searchPattern, Boolean useRegex, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'subscriptionId' is set
        if (subscriptionId == null) {
            throw new ApiException("Missing the required parameter 'subscriptionId' when calling reportFolderAndFileCountRecycleBinFoldersAndFiles(Async)");
        }

        return reportFolderAndFileCountRecycleBinFoldersAndFilesCall(subscriptionId, searchPattern, useRegex, _callback);
     ...
     */
    public CountVM reportFolderAndFileCountRecycleBinFoldersAndFiles(String subscriptionId, String searchPattern, Boolean useRegex) throws ApiException {
        ApiResponse<CountVM> localVarResp = reportFolderAndFileCountRecycleBinFoldersAndFilesWithHttpInfo(subscriptionId, searchPattern, useRegex);
     ...
     */
    public ApiResponse<CountVM> reportFolderAndFileCountRecycleBinFoldersAndFilesWithHttpInfo(String subscriptionId, String searchPattern, Boolean useRegex) throws ApiException {
        okhttp3.Call localVarCall = reportFolderAndFileCountRecycleBinFoldersAndFilesValidateBeforeCall(subscriptionId, searchPattern, useRegex, null);
     ...
     */
    public okhttp3.Call reportFolderAndFileCountRecycleBinFoldersAndFilesAsync(String subscriptionId, String searchPattern, Boolean useRegex, final ApiCallback<CountVM> _callback) throws ApiException {

        okhttp3.Call localVarCall = reportFolderAndFileCountRecycleBinFoldersAndFilesValidateBeforeCall(subscriptionId, searchPattern, useRegex, _callback);
        Type localVarReturnType = new TypeToken<CountVM>(){}.getType();
    ...
    /**
     * Build call for reportsCreateSharingKey
     * @param id file id (required)
     ...
     */
    public okhttp3.Call reportsCreateSharingKeyCall(String id, CreateFileShareVM createFileShareVM, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/rp/v1/Reports/File/{id}/sharingKey"
            .replace("{" + "id" + "}", localVarApiClient.escapeString(id.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call reportsCreateSharingKeyValidateBeforeCall(String id, CreateFileShareVM createFileShareVM, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling reportsCreateSharingKey(Async)");
        }

        return reportsCreateSharingKeyCall(id, createFileShareVM, _callback);
     ...
     */
    public FileSharingKeysVM reportsCreateSharingKey(String id, CreateFileShareVM createFileShareVM) throws ApiException {
        ApiResponse<FileSharingKeysVM> localVarResp = reportsCreateSharingKeyWithHttpInfo(id, createFileShareVM);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<FileSharingKeysVM> reportsCreateSharingKeyWithHttpInfo(String id, CreateFileShareVM createFileShareVM) throws ApiException {
        okhttp3.Call localVarCall = reportsCreateSharingKeyValidateBeforeCall(id, createFileShareVM, null);
     ...
     */
    public okhttp3.Call reportsCreateSharingKeyAsync(String id, CreateFileShareVM createFileShareVM, final ApiCallback<FileSharingKeysVM> _callback) throws ApiException {

        okhttp3.Call localVarCall = reportsCreateSharingKeyValidateBeforeCall(id, createFileShareVM, _callback);
        Type localVarReturnType = new TypeToken<FileSharingKeysVM>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    /**
     * Build call for reportsDeleteSharingKey
     * @param id file id (required)
     ...
     */
    public okhttp3.Call reportsDeleteSharingKeyCall(String id, String key, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call reportsDeleteSharingKeyValidateBeforeCall(String id, String key, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling reportsDeleteSharingKey(Async)");
        }

        // verify the required parameter 'key' is set
        if (key == null) {
            throw new ApiException("Missing the required parameter 'key' when calling reportsDeleteSharingKey(Async)");
        }

        return reportsDeleteSharingKeyCall(id, key, _callback);
     ...
     */
    public void reportsDeleteSharingKey(String id, String key) throws ApiException {
     ...
     */
    public ApiResponse<Void> reportsDeleteSharingKeyWithHttpInfo(String id, String key) throws ApiException {
        okhttp3.Call localVarCall = reportsDeleteSharingKeyValidateBeforeCall(id, key, null);
        return localVarApiClient.execute(localVarCall);
    }
     ...
     */
    public okhttp3.Call reportsDeleteSharingKeyAsync(String id, String key, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = reportsDeleteSharingKeyValidateBeforeCall(id, key, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
    ...
    /**
     * Build call for reportsGetSharingKeys
     * @param id file id (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call reportsGetSharingKeysCall(String id, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/rp/v1/Reports/File/{id}/sharingKeys"
            .replace("{" + "id" + "}", localVarApiClient.escapeString(id.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call reportsGetSharingKeysValidateBeforeCall(String id, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling reportsGetSharingKeys(Async)");
        }

        return reportsGetSharingKeysCall(id, _callback);
     ...
     */
    public FileSharingKeysVM reportsGetSharingKeys(String id) throws ApiException {
        ApiResponse<FileSharingKeysVM> localVarResp = reportsGetSharingKeysWithHttpInfo(id);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<FileSharingKeysVM> reportsGetSharingKeysWithHttpInfo(String id) throws ApiException {
        okhttp3.Call localVarCall = reportsGetSharingKeysValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<FileSharingKeysVM>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call reportsGetSharingKeysAsync(String id, final ApiCallback<FileSharingKeysVM> _callback) throws ApiException {

        okhttp3.Call localVarCall = reportsGetSharingKeysValidateBeforeCall(id, _callback);
        Type localVarReturnType = new TypeToken<FileSharingKeysVM>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
