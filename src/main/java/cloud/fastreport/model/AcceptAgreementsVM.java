...
public class AcceptAgreementsVM {
  ...
  **/
  ...
  /**
   * Return true if this AcceptAgreementsVM object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `slaAccepted` to the URL query string
    if (getSlaAccepted() != null) {
      joiner.add(String.format("%sslaAccepted%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getSlaAccepted()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
