...
public class AdminReportFolderCreateVM {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.name, adminReportFolderCreateVM.name) &&
        equalsNullable(this.tags, adminReportFolderCreateVM.tags) &&
        equalsNullable(this.icon, adminReportFolderCreateVM.icon);
  }
