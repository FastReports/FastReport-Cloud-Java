...
@JsonPropertyOrder({
  ...
  AuditActionVM.JSON_PROPERTY_$_T
})
...
public class AuditActionVM {
  ...
  **/
  ...
  /**
   * Return true if this AuditActionVM object is equal to o.
   */
  @Override
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(userId), hashCodeNullable(entityId), hashCodeNullable(subscriptionId), type, hashCodeNullable(id), createdTime, hashCodeNullable(creatorUserId), hashCodeNullable(name), adminAction, $t);
  }
...
static {
  ...
  mappings.put("AuditActionVM", AuditActionVM.class);
  JSON.registerDiscriminator(AuditActionVM.class, "$t", mappings);
}
}
