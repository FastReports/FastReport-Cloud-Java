...
@JsonPropertyOrder({
  ...
  CreateGroupVM.JSON_PROPERTY_$_T
})
...
@JsonSubTypes({
  @JsonSubTypes.Type(value = CreateGroupAdminVM.class, name = "CreateGroupAdminVM"),
  @JsonSubTypes.Type(value = CreateGroupVM.class, name = "CreateGroupVM"),
})
...
public class CreateGroupVM {
  ...
  **/
  ...
  /**
   * Return true if this CreateGroupVM object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, createGroupVM.name) &&
        equalsNullable(this.subscriptionId, createGroupVM.subscriptionId) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, hashCodeNullable(subscriptionId), $t);
  }
...
static {
  ...
  mappings.put("CreateGroupVM", CreateGroupVM.class);
  mappings.put("CreateGroupVM", CreateGroupVM.class);
  JSON.registerDiscriminator(CreateGroupVM.class, "$t", mappings);
}
}
