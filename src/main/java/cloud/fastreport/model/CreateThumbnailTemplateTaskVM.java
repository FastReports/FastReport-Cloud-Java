...
public class CreateThumbnailTemplateTaskVM {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.name, createThumbnailTemplateTaskVM.name) &&
        equalsNullable(this.subscriptionId, createThumbnailTemplateTaskVM.subscriptionId) &&
        Objects.equals(this.type, createThumbnailTemplateTaskVM.type) &&
        equalsNullable(this.delayedRunTime, createThumbnailTemplateTaskVM.delayedRunTime) &&
        equalsNullable(this.cronExpression, createThumbnailTemplateTaskVM.cronExpression);
  }
