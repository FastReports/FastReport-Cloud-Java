...
public class ExportFolderCreateVM {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.name, exportFolderCreateVM.name) &&
        equalsNullable(this.tags, exportFolderCreateVM.tags) &&
        equalsNullable(this.icon, exportFolderCreateVM.icon);
  }
