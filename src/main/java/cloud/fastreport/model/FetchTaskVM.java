...
public class FetchTaskVM {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.name, fetchTaskVM.name) &&
        equalsNullable(this.subscriptionId, fetchTaskVM.subscriptionId) &&
        Objects.equals(this.type, fetchTaskVM.type) &&
        equalsNullable(this.delayedRunTime, fetchTaskVM.delayedRunTime) &&
        equalsNullable(this.cronExpression, fetchTaskVM.cronExpression);
  }
