...
public class FilePermission {
  ...
  * @throws IOException if the JSON Element is invalid with respect to FilePermission
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FilePermission.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FilePermission is not found in the empty JSON string", FilePermission.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FilePermission.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FilePermission` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FilePermission.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FilePermission' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FilePermission> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FilePermission.class));

       return (TypeAdapter<T>) new TypeAdapter<FilePermission>() {
           @Override
           public void write(JsonWriter out, FilePermission value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FilePermission read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of FilePermission given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FilePermission
  * @throws IOException if the JSON string is invalid with respect to FilePermission
  */
  public static FilePermission fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FilePermission.class);
  }

 /**
  * Convert an instance of FilePermission to an JSON string
  *
  * @return JSON string
  */
