...
public class ReportFolderCreateVM {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.name, reportFolderCreateVM.name) &&
        equalsNullable(this.tags, reportFolderCreateVM.tags) &&
        equalsNullable(this.icon, reportFolderCreateVM.icon);
  }
