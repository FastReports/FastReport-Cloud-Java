...
public class RunExportReportTaskVM extends RunTransformTaskBaseVM {
  ...
  * @throws IOException if the JSON Element is invalid with respect to RunExportReportTaskVM
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RunExportReportTaskVM.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RunExportReportTaskVM is not found in the empty JSON string", RunExportReportTaskVM.openapiRequiredFields.toString()));
        }
      }
 ...
 /**
  * Create an instance of RunExportReportTaskVM given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RunExportReportTaskVM
  * @throws IOException if the JSON string is invalid with respect to RunExportReportTaskVM
  */
  public static RunExportReportTaskVM fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RunExportReportTaskVM.class);
  }

 /**
  * Convert an instance of RunExportReportTaskVM to an JSON string
  *
  * @return JSON string
  */
