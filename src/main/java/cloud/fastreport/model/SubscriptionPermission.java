...
public class SubscriptionPermission {
  ...
  * @throws IOException if the JSON Element is invalid with respect to SubscriptionPermission
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SubscriptionPermission.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SubscriptionPermission is not found in the empty JSON string", SubscriptionPermission.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SubscriptionPermission.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SubscriptionPermission` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SubscriptionPermission.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SubscriptionPermission' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SubscriptionPermission> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SubscriptionPermission.class));

       return (TypeAdapter<T>) new TypeAdapter<SubscriptionPermission>() {
           @Override
           public void write(JsonWriter out, SubscriptionPermission value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SubscriptionPermission read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of SubscriptionPermission given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SubscriptionPermission
  * @throws IOException if the JSON string is invalid with respect to SubscriptionPermission
  */
  public static SubscriptionPermission fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SubscriptionPermission.class);
  }

 /**
  * Convert an instance of SubscriptionPermission to an JSON string
  *
  * @return JSON string
  */
