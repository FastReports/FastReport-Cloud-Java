...
public class SubscriptionPermissions {
  ...
  * @throws IOException if the JSON Element is invalid with respect to SubscriptionPermissions
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SubscriptionPermissions.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SubscriptionPermissions is not found in the empty JSON string", SubscriptionPermissions.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SubscriptionPermissions.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SubscriptionPermissions` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SubscriptionPermissions.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SubscriptionPermissions' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SubscriptionPermissions> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SubscriptionPermissions.class));

       return (TypeAdapter<T>) new TypeAdapter<SubscriptionPermissions>() {
           @Override
           public void write(JsonWriter out, SubscriptionPermissions value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SubscriptionPermissions read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of SubscriptionPermissions given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SubscriptionPermissions
  * @throws IOException if the JSON string is invalid with respect to SubscriptionPermissions
  */
  public static SubscriptionPermissions fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SubscriptionPermissions.class);
  }

 /**
  * Convert an instance of SubscriptionPermissions to an JSON string
  *
  * @return JSON string
  */
