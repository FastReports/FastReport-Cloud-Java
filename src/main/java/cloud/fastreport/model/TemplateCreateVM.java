 ...
 */
@JsonPropertyOrder({
  TemplateCreateVM.JSON_PROPERTY_$_T
})
...
public class TemplateCreateVM extends FileCreateVM {
  ...
  **/
  ...
  /**
   * Return true if this TemplateCreateVM object is equal to o.
   */
  @Override
...
static {
  ...
  mappings.put("TemplateCreateVM", TemplateCreateVM.class);
  JSON.registerDiscriminator(TemplateCreateVM.class, "$t", mappings);
}
}
