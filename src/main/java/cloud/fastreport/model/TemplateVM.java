...
@JsonPropertyOrder({
  ...
  TemplateVM.JSON_PROPERTY_NAME,
  TemplateVM.JSON_PROPERTY_PARENT_ID,
  TemplateVM.JSON_PROPERTY_TAGS,
  TemplateVM.JSON_PROPERTY_ICON,
  TemplateVM.JSON_PROPERTY_TYPE,
  TemplateVM.JSON_PROPERTY_SIZE,
  TemplateVM.JSON_PROPERTY_SUBSCRIPTION_ID,
  TemplateVM.JSON_PROPERTY_STATUS,
  TemplateVM.JSON_PROPERTY_STATUS_REASON,
...
public class TemplateVM {
  ...
  **/
  ...
  public TemplateVM addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  **/
  ...
  public TemplateVM type(TypeEnum type) {
  ...
  **/
  ...
  public TemplateVM status(StatusEnum status) {
  ...
  **/
  ...
  public TemplateVM statusReason(StatusReasonEnum statusReason) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.reportInfo, templateVM.reportInfo) &&
        Objects.equals(this.name, templateVM.name) &&
        Objects.equals(this.parentId, templateVM.parentId) &&
        Objects.equals(this.tags, templateVM.tags) &&
        Arrays.equals(this.icon, templateVM.icon) &&
        Objects.equals(this.type, templateVM.type) &&
        Objects.equals(this.size, templateVM.size) &&
        Objects.equals(this.subscriptionId, templateVM.subscriptionId) &&
        Objects.equals(this.status, templateVM.status) &&
        Objects.equals(this.statusReason, templateVM.statusReason) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(reportInfo, name, parentId, tags, Arrays.hashCode(icon), type, size, subscriptionId, status, statusReason, id, createdTime, creatorUserId, editedTime, editorUserId);
  }
