...
public class TransportTaskBaseVM extends TaskBaseVM {
  ...
  * @throws IOException if the JSON Element is invalid with respect to TransportTaskBaseVM
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TransportTaskBaseVM.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TransportTaskBaseVM is not found in the empty JSON string", TransportTaskBaseVM.openapiRequiredFields.toString()));
        }
      }
 ...
 /**
  * Create an instance of TransportTaskBaseVM given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TransportTaskBaseVM
  * @throws IOException if the JSON string is invalid with respect to TransportTaskBaseVM
  */
  public static TransportTaskBaseVM fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TransportTaskBaseVM.class);
  }

 /**
  * Convert an instance of TransportTaskBaseVM to an JSON string
  *
  * @return JSON string
  */
