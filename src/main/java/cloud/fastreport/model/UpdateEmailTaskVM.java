...
public class UpdateEmailTaskVM extends UpdateTransportTaskBaseVM {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(password), hashCodeNullable(body), hashCodeNullable(isBodyHtml), hashCodeNullable(subject), hashCodeNullable(to), toUpdateType, hashCodeNullable(from), hashCodeNullable(username), hashCodeNullable(server), hashCodeNullable(port), hashCodeNullable(enableSsl), super.hashCode());
  }
